...
// Apps register their language source at startup via setLanguageBindings.
// Default fallback covers the case where shared modules run before the host wires bindings.
let useLanguageHook: () => Language = () => "tr";
let getLanguageSync: () => Language = () => "tr";
...
export function setLanguageBindings(bindings: LanguageBindings): void {
  useLanguageHook = bindings.useLanguage;
  getLanguageSync = bindings.getLanguage;
}
