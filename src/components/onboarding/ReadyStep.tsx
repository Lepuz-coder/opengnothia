    ...
    <div className="text-center space-y-6">
      ...
      <div>
        ...
        <p className="text-[var(--text-secondary)] mt-2">
          Seni her gün <span className="font-semibold text-primary-600 dark:text-primary-400">{preferredSessionTime}</span>'de bekliyorum.
        </p>
      </div>

      <div className="p-4 rounded-xl bg-primary-50 dark:bg-primary-900/20 text-sm text-[var(--text-secondary)]">
        <p>
