...
pub fn run() {
    let migrations = vec![
        Migration {
            ...
            sql: include_str!("../../../../packages/shared/migrations/001_initial.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 2,
            description: "add therapist_notes to sessions",
            sql: include_str!("../../../../packages/shared/migrations/002_add_therapist_notes.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 3,
            description: "add patient_notes table",
            sql: include_str!("../../../../packages/shared/migrations/003_add_patient_notes.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 4,
            description: "add summary_narrative to sessions",
            sql: include_str!("../../../../packages/shared/migrations/004_add_summary_narrative.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 5,
            description: "add token_usage table",
            sql: include_str!("../../../../packages/shared/migrations/005_add_token_usage.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 6,
            description: "add age, gender, occupation to user_profile",
            sql: include_str!("../../../../packages/shared/migrations/006_add_profile_fields.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 7,
            description: "add dreams table",
            sql: include_str!("../../../../packages/shared/migrations/007_add_dreams.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 8,
            description: "add ai_analysis to journal_entries",
            sql: include_str!("../../../../packages/shared/migrations/008_add_journal_analysis.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 9,
            description: "add date column to dreams",
            sql: include_str!("../../../../packages/shared/migrations/009_add_dream_date.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 10,
            description: "add mood_entries table",
            sql: include_str!("../../../../packages/shared/migrations/010_add_mood_entries.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 11,
            description: "add weekly_summaries table",
            sql: include_str!("../../../../packages/shared/migrations/011_add_weekly_summaries.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 12,
            description: "add insight_groups and insights tables",
            sql: include_str!("../../../../packages/shared/migrations/012_add_insights.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 13,
            description: "add milestone_analyses table",
            sql: include_str!("../../../../packages/shared/migrations/013_add_milestone_analyses.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 14,
            description: "add course_progress table",
            sql: include_str!("../../../../packages/shared/migrations/014_add_courses.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 15,
            description: "add progress column to course_progress",
            sql: include_str!("../../../../packages/shared/migrations/015_add_course_step_progress.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 16,
            description: "add course_notes table",
            sql: include_str!("../../../../packages/shared/migrations/016_add_course_notes.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 17,
